...
#define TSC2007_ADDRESS         0x94//0x4A//0x90//0x4A//
...
uint16_t tsc2007_MeasureZ1pos(void)
{
	...
	HAL_I2C_Master_Receive(&hEvalI2c, TSC2007_ADDRESS, Z1pos, 2, 100);
...
uint16_t tsc2007_MeasureZ2pos(void)
{
	...
	HAL_I2C_Master_Receive(&hEvalI2c, TSC2007_ADDRESS, Z2pos, 2, 100);
